    ...
    >
        ...
        <DialogContent>
          {createStep === "choose" ? (
            ...
            <>
              ...
              <IconPicker value={newIcon} onChange={setNewIcon} options={CATEGORY_ICON_OPTIONS} />
              <DialogFooter>
      ...
      <Dialog open={!!editingCategory} onOpenChange={(open) => !open && setEditingCategory(null)}>
        <DialogContent>
          ...
          <IconPicker value={editIcon} onChange={setEditIcon} options={CATEGORY_ICON_OPTIONS} />
          <DialogFooter>
