...
export const CATEGORY_ICON_OPTIONS: { value: string; label: string; icon: LucideIcon }[] = [
  ...
  // PJ / operação
  { value: "business", label: "Empresa/PJ", icon: BriefcaseBusiness },
  { value: "business_revenue", label: "Receitas da empresa", icon: BadgeDollarSign },
  { value: "sales", label: "Vendas", icon: Store },
  { value: "operations", label: "Produção/Operação", icon: Factory },
  { value: "revenue_pix", label: "Receitas Pix", icon: QrCode },
  { value: "revenue_card", label: "Receitas cartão", icon: CreditCard },
  { value: "revenue_cash", label: "Receitas em dinheiro", icon: BanknoteArrowUp },
  { value: "revenue_transfer", label: "Receitas por transferência", icon: Landmark },
  { value: "systems", label: "Sistemas", icon: MonitorCog },
  { value: "software", label: "Software", icon: Laptop },
  { value: "accounting_business", label: "Contabilidade PJ", icon: FileSpreadsheet },
  { value: "taxes_business", label: "Impostos PJ", icon: ReceiptText },
  { value: "employees", label: "Funcionários", icon: UsersRound },
  { value: "payroll_business", label: "Folha PJ", icon: HandCoins },
  { value: "stock", label: "Estoque", icon: Boxes },
  { value: "inventory_control", label: "Controle de estoque", icon: ClipboardList },
  { value: "products", label: "Produtos", icon: Package },
  { value: "finished_goods", label: "Mercadorias", icon: PackageCheck },
  { value: "suppliers", label: "Fornecedores", icon: Truck },
  { value: "supplies", label: "Suprimentos", icon: PackageSearch },
  { value: "office_supplies", label: "Material de escritório", icon: Printer },
  { value: "cleaning_supplies", label: "Material de limpeza", icon: SprayCan },
  { value: "medical_supplies", label: "Material cirúrgico", icon: Syringe },
  { value: "clinical_materials", label: "Material clínico", icon: Cross },
  { value: "ppe", label: "EPIs", icon: HardHat },
  { value: "documents", label: "Documentos", icon: FileText },
  { value: "contracts", label: "Contratos", icon: FileText },
  { value: "storage_archive", label: "Arquivo/armazenagem", icon: Archive },
  { value: "business_metrics", label: "Indicadores", icon: ChartNoAxesColumnIncreasing },
